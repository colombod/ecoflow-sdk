...
class SmartPlugData:
    ...
    is_on: bool
    power_watts: float
    """Actual wattage in W. QUIRK: raw 'watts' field is 10× (× WATTS_RAW_FACTOR)."""
    voltage: float
    current: float
    ...
    @classmethod
    def from_mqtt_payload(cls, sn: str, data: dict[str, Any]) -> SmartPlugData:
        """Build a SmartPlugData snapshot from a raw MQTT payload dict."""
        hb: dict[str, Any] = data.get("plug_heartbeat", data)
        ...
        return cls(
            ...
            online=True,
            is_on=is_on,
            power_watts=float(hb.get("watts", 0)) * WATTS_RAW_FACTOR,
    ...
    @classmethod
    def from_quota_payload(cls, sn: str, data: dict[str, Any]) -> SmartPlugData:
        ...
        return cls(
            ...
            power_watts=data.get("2_1.watts", 0) * WATTS_RAW_FACTOR,
